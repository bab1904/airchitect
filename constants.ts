import { Worker, Material, ProjectStats, Project, ClientRequest, UserRole, TeamMessage, Vendor, MaterialRequest, DailyAttendance, SecurityAlert, GeneratedDocument, DailyLog } from './types';
...
export const MOCK_PERMITS: GeneratedDocument[] = [
    {
      id: 'prm1',
      projectId: 'p1',
